...
public class Queen {
     ...
     *
     * @param strict If we are strict the Queen will halt if it cannot load it's configuration. This is needed when it is first run.
    ...
    /**
     * Reads email addresses from the email list specified in the configuration file.
     */
    ...
    /**
     * Reads server addresses from the server list specified in the configuration file.
     */
    ...
    /**
     * Stores information about a drone in MySQL
     *
     * @param name          The name of the Drone.
     * @param connection_id The connection ID that the Drone has.
     */
    ...
    /**
     * Marks a job as complete, and removes a counter on the server that keeps track of how many jobs are activly going to it.
     *
     * @param job_name The name of the job that was generated by the Queen
     * @param server   The address of the server that was allocated to this job.
     */
    ...
    /**
     * Reads the auth key that was provided by google into memory as a string
     *
     * @return The gmail Oauth key as a string
     */
    ...
    /**
     * Sends a prepared workload to a client Drone.
     *
     * @param conn The active connection to the Drone
     * @param name The name of the Drone
     */
